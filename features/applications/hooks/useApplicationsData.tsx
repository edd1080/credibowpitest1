...
export const useApplicationsData = (searchQuery: string, selectedTab: ApplicationStatus) => {
  ...
  const applications: Application[] = useMemo(() => [
    ...
    { 
      id: '4', 
      applicationId: 'SCO_971387',
      clientName: 'Ana Rodríguez Silva', 
      amount: 20000, 
      status: 'rejected', 
      date: '2025-06-17', 
      syncStatus: 'synced', 
    ...
    { 
      id: '5', 
      applicationId: 'SCO_971386',
      clientName: 'Pedro González Mejía', 
      amount: 5000, 
      status: 'pending', 
      date: '2025-06-16', 
      syncStatus: 'error', 
    ...
    { 
      id: '6', 
      applicationId: 'SCO_971385',
      clientName: 'Lucía Martínez Cruz', 
      amount: 18000, 
      status: 'approved', 
      date: '2025-06-15', 
      syncStatus: 'synced', 
